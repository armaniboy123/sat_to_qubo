...
# Experiment
#
# Im Unterschied zum Variablen-Experiment (5.3) bleibt hier
# n_vars fix; stattdessen wird n_clauses (bzw. die Dichte
# n_clauses / n_vars) als Sweep-Parameter variiert.
# =====================================================
...
# Klausel-Dichte = Klauseln pro Variable (n_clauses = density * n_vars)
CLAUSE_DENSITIES = [1, 2, 3, 4, 5, 6]
...
plt.xlabel("Clause Density (clauses / variable)")

plt.ylabel("Success Rate")

plt.title(
    f"Success Rate vs Clause Density (variables = {N_VARS})"
)

plt.grid(True)

plt.savefig(
    "success_vs_density.png"
)
...
plt.title(
    f"Runtime vs Clause Density (variables = {N_VARS})"
)
